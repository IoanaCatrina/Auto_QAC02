...
public class ExceptionsChecked {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Aria cercului: " + Area.getCircleArea(radius));

            double side = Double.parseDouble(args[1]);
            System.out.println("Aria patratului este: " + Area.getSquareArea(side));
...
//            always run
            System.out.println("Clean up: Close browser at end");
        }
    }
}
